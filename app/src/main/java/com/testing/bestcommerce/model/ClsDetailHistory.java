...
public class ClsDetailHistory {
    int id,id_checkout,id_produk,id_penjual,id_user,qty,status_checkout,status_pengiriman;
    String nama_produk,image,alamat_pengiriman,kurir,order_number,created_by,created_date,modified_by,modified_date;
